...
/**
 * BookingHistorySelectionPage Component
 *
 * Admin-only page for selecting which advertiser or agency booking history to view.
 * Features two tabs with URL-synced state:
 * - Advertiser Bookings: Browse and select advertisers
 * - Agency Bookings: Browse and select agencies
 *
    ...
    <div className="flex flex-col h-full overflow-auto">
      <div className="flex-1 p-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Select an advertiser or agency to view their booking history</p>
        </div>

        {/* Selection Card with Tabs */}
        <Card>
          <CardHeader>
            <CardTitle>Select Booking History to View</CardTitle>
          </CardHeader>
          <CardContent>
...
export default BookingHistorySelectionPage;
