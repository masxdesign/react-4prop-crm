...
/**
 * AdvertiserSelectionTable Component
 *
 ...
 * Clicking a row navigates to that advertiser's statistics page.
 */
const AdvertiserSelectionTable = () => {
  ...
  // Handle row click - navigate to advertiser stats page
  const handleRowClick = (advertiser) => {
    navigate({ to: `/crm/stats/advertiser/${advertiser.id}` });
  };
