...
const variants = {
  ...
  thumbnail: {
    ...
    pillClass: 'mt-2 px-2 py-0.5 rounded-full bg-orange-500 text-white text-xs font-semibold tracking-wider uppercase',
    padClass: 'px-4',
  },
}

export default function FeaturedImageOverlay({ imageUrl, street, city, postcode, variant = 'full' }) {
