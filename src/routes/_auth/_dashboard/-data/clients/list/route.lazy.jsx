...
import LogChatboxContainer from '@/routes/_auth/_dashboard/-data/clients/list/-ui/LogChatboxContainer';
import ClientFormEdit from '../-ui/ClientFormEdit';
import CategoriesPrimitive from '@/routes/--ui/CategoriesPrimitive';


export const Route = createLazyFileRoute('/_admin/_dashboard/dashboard/data/clients/list')({
